...
| Full-case baselines are not generated | A realistic whole-case synthesis comparison would test broader erosion. | Worked-region baselines test the core mechanism. | Add full-case flat baselines from all source abstracts/excerpts. |
