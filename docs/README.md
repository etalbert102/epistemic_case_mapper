...
Start with [START_HERE.md](START_HERE.md). Documentation is grouped by reviewer
need rather than development chronology.
...
| [`review/`](review/) | Human-review packets and checklists |
| [`guides/`](guides/) | Pipeline operation, new cases, and package configuration |
| [`validation/`](validation/) | Validation profiles and failure diagnostics |
