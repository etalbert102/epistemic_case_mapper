# FLF Contest Form Text

Prepared for the live **FLF Epistemic Case Study Competition** submission form.
Replace only the bracketed personal fields before submitting.
...
[Leave blank if submitting solo, or list each collaborator's name and email]

## LinkedIn and/or personal website

[Your LinkedIn and/or personal website, or leave blank]

## About you

[Write 2-3 sentences covering your current role or field, relevant experience
with AI-assisted research or software engineering, and interest in epistemic
tools. If the link above covers this, use: "See LinkedIn/website above."]

## Are you requesting early feedback?
...
## Which layer(s) does your submission address?

All / integrated

## Primary Document or Drive URL

https://github.com/etalbert102/epistemic_case_mapper/blob/main/docs/START_HERE.md

## Repo URL

https://github.com/etalbert102/epistemic_case_mapper
...
Yes. I would be interested in follow-on work focused on human evaluation,
second-investigator handoff, reviewer decision capture, fresh-case transfer,
and improving reliable model-assisted extraction and relation labeling. [Add
your availability, preferred working arrangement, and any constraints.]
...
[State where you first encountered the competition, for example the FLF site,
LessWrong, EA Forum, LinkedIn, or a colleague]

## Final Pre-Submission Check

- Replace every bracketed field.
- Confirm the GitHub repository is public while judges review it.
- Open both URLs in a signed-out browser window.
- Submit before July 19, 2026, Anywhere on Earth.
