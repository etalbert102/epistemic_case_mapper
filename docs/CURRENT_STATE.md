...
- The LLM/deterministic work split is documented in `docs/LLM_DETERMINISTIC_SPLIT.md`, with `ecm semantic prompt ...` and `ecm semantic validate ...` commands for model-assisted candidate maps and critiques.
