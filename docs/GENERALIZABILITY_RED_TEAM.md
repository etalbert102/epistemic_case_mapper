...
| Fast-moving current question | Stable IDs and update triggers should help, but source churn may dominate. | `docs/NEW_SOURCE_UPDATE_DEMO.md` shows one source-update pattern, not a live case. | Partial fit. |
