...
The checked-in repair diff is preserved at
`examples/investigator_challenge/mutation/lhc/repair_diff.md`.
...
The checked-in update ledger is preserved at
`examples/investigator_challenge/update/lhc/affected_object_ledger.json`; the
map diff is preserved at
`examples/investigator_challenge/update/lhc/map_update_diff.md`.
