...
Question: Which later result is only a subargument rather than a whole-case resolution?

The map condition can recover these frozen answer-key objects:

## later_result_subargument_boundary

A later result may resolve or weaken a subargument without resolving the whole origins question.
