...
REGIONS = (
    ...
    {
        "region_id": "covid_bayesian_disagreement",
        "case_path": "data/cases/covid_origins_slice/case.yaml",
        "definition": "docs/worked_regions/covid_bayesian_disagreement.md",
        "map": "examples/covid_origins_slice/worked_region_bayesian_disagreement_map.md",
        "baseline": "examples/covid_origins_slice/flat_synthesis_baseline.md",
        "audit": "examples/covid_origins_slice/decision_space_erosion_audit.md",
        "best": "examples/covid_origins_slice/BEST_REGIONS.md",
        "required_sources": {
