...
- raw flat response: `raw/lhc/flat/lhc_t001_response.md`
- raw map response: `raw/lhc/map/lhc_t001_response.md`
...
- raw flat response: `raw/lhc/flat/lhc_t003_response.md`
- raw map response: `raw/lhc/map/lhc_t003_response.md`
...
- map composite: 0.833
- map + sources composite: 0.917
- raw flat response: `raw/lhc/flat/lhc_t004_response.md`
- raw map response: `raw/lhc/map/lhc_t004_response.md`
...
| lhc token report | `inputs/lhc/token_budget_report.json` |
| eggs scoring | `scoring/eggs/task_scores.json` |
| eggs token report | `inputs/eggs/token_budget_report.json` |
| covid scoring | `scoring/covid/task_scores.json` |
| covid token report | `inputs/covid/token_budget_report.json` |
