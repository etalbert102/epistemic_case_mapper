...
from epistemic_case_mapper.map_briefing_artifacts import write_run_summary
...
def prepare_map_briefing_inputs(
    *,
    ...
    from epistemic_case_mapper.map_briefing_reader_contracts import annotate_map_with_evidence_slots
