...
def _decision_brief_bluf_prompt(contract: dict[str, Any], body_memo: str, fallback: str) -> str:
    ...
    return (
        ...
        "Use the canonical decision spine and accepted body sections below as the source of truth.\n"
        ...
        "Use generic labels such as beneficial, harmful, neutral, use, or avoid only when that exact framing is warranted by the answer frame and accepted body sections.\n"
        ...
        "Return the rewritten Decision Brief section as Markdown with no additional sections.\n\n"
...
def decision_brief_repair_prompt(contract: dict[str, Any], body_memo: str, rejected_section: str, issues: list[str]) -> str:
    ...
    return (
        ...
        "Repair the rejected section with the smallest changes needed to fix the validation failures.\n"
        "Use the controlling answer frame, accepted body sections, and rejected section below as the source of truth.\n"
        "The opening must answer the decision question before caveats, preserve the question line and confidence line, and keep a bounded answer calibrated.\n"
        "Return the corrected Decision Brief section as Markdown with no additional sections.\n\n"
