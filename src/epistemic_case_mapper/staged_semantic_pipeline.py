...
_SHARD_NAMES = [
    'epistemic_case_mapper.staged_semantic_pipeline_impl_1',
    'epistemic_case_mapper.staged_semantic_pipeline_impl_2',
    'epistemic_case_mapper.staged_semantic_pipeline_impl_3',
    'epistemic_case_mapper.staged_semantic_pipeline_impl_4',
]
