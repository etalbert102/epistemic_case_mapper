...
def build_full_memo_polish_prompt(memo: str, obligation_packet: dict[str, Any], *, previous_issues: list[str] | None = None) -> str:
    ...
    return (
        ...
        "- Preserve the required evidence checklist below, but do not preserve every repeated sentence.\n"
...
def build_full_memo_polish_patch_prompt(memo: str, issues: list[str], obligation_packet: dict[str, Any]) -> str:
    return (
        ...
        "- Do not add new sources, numbers, populations, recommendations, or causal interpretations.\n"
...
def build_full_memo_warning_repair_prompt(memo: str, warnings: list[str], repair_packet: dict[str, Any] | None = None) -> str:
    ...
    return (
        ...
        "If a warning cannot be corrected without guessing or adding unsupported facts, leave the memo unchanged on that point.\n\n"
        "Rules:\n"
        "- Return the full revised memo in Markdown.\n"
        "- Do not return JSON.\n"
        "- Do not add new facts, sources, numbers, populations, recommendations, or causal interpretations beyond the memo, warnings, or repair packet.\n"
        "- Preserve the decision question, confidence line, uncertainty, and final Sources section.\n"
        ...
        "- Do not paste checklist fragments mechanically. If a suggested insertion is awkward, truncated, or schema-like, preserve only its supported meaning in fluent prose.\n"
...
def _full_memo_polish_target_instruction(memo: str) -> str:
    ...
    return "produce a coherent memo about the same length or shorter; do not expand a compact memo just to match a fixed word count."
