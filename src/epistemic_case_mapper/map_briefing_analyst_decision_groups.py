    ...
    return _drop_empty(
        {
            ...
            "answer_relation": str(row.get("answer_relation") or "").strip(),
            "target_answer_option": _short_text(str(row.get("target_answer_option") or ""), 220),
            "effect_on_final_answer": _short_text(str(row.get("effect_on_final_answer") or ""), 260),
            "tension_type": str(row.get("tension_type") or "").strip(),
