...
def build_paragraph_memo_polish_prompt(
    ...
    *,
    ...
    return (
        ...
        "- Keep neighboring paragraphs in mind only for transition fit; do not rewrite them.\n\n"
        "Style target:\n"
        ...
        "- Do not include other paragraphs or section headings unless they are already part of the target paragraph.\n"
        "- Do not add facts, numbers, source IDs, populations, recommendations, or comparisons not already in this paragraph or guardrails.\n"
        "- If no safe improvement is available, return the paragraph unchanged.\n\n"
