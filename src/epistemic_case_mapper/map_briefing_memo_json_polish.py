...
from epistemic_case_mapper.map_briefing_memo_ready_packet_helpers import list_value as _list, norm as _norm
...
def build_memo_ready_json_edit_polish_prompt(
    ...
    *,
    ...
    return (
        ...
        "- Replacement text may rewrite a paragraph or adjacent paragraph block for flow, but must not add new facts, numbers, sources, populations, recommendations, or comparisons.\n"
        ...
        "- Do not propose cosmetic synonym swaps; propose edits that materially improve the read.\n"
