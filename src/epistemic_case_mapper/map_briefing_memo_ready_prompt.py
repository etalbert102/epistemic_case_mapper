...
def build_writer_packet_synthesis_prompt(
    ...
    *,
    ...
    return (
        ...
        "Use reader_brief_plan.paragraph_jobs as the writing plan. Use decision_interpretation_plan as the meaning layer that explains what each evidence item should do for the decision. Use decision_evidence_table, reasoning_hierarchy, analytical_balance_contract, and decision_boundary_source_contract only to support that plan. Use mandatory_evidence_ledger as the non-negotiable retention check after drafting, not as the memo outline. Merge related ledger rows into the same paragraph when that reads better.\n\n"
        "Required visible structure:\n"
        "# Decision Memo: <short title>\n"
        "**Decision Question:** <question>\n"
        ...
        "- Use decision_interpretation_plan.quantity_meanings when turning quantities into plain decision meaning.\n"
        "- Use decision_interpretation_plan.answer_effect and reader_use to decide whether evidence belongs in the main reason, counterweight disposition, scope boundary, or crux discussion.\n"
