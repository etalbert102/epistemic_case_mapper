            ...
            _drop_empty(
                {
                    ...
                    "decision_contribution": _short_text(str(ledger_row.get("decision_contribution") or ""), 180),
                    "key_qualifier": _short_text(str(ledger_row.get("key_qualifier") or ""), 140),
                    "misuse_warning": _short_text(str(ledger_row.get("misuse_warning") or ""), 160),
