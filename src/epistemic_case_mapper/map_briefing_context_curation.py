        ...
        cards.append(
            {
                ...
                "population": str(source_card.get("population") or ""),
                "exposure_or_intervention": str(source_card.get("exposure_or_intervention") or ""),
                "outcome_or_endpoint": str(source_card.get("outcome_or_endpoint") or ""),
                "evidence_type": str(source_card.get("evidence_type") or ""),
                "natural_bottom_line": str(source_card.get("natural_bottom_line") or ""),
