...
from epistemic_case_mapper.pipeline.briefing.decision_frame import (
    build_decision_frame,
    question_quality_report,
    refine_crux_contract,
)
from epistemic_case_mapper.pipeline.briefing.map_briefing_artifacts import write_gap_telemetry_outputs, write_scaffold_artifacts
from epistemic_case_mapper.pipeline.briefing.map_briefing_argument_model import build_argument_model
from epistemic_case_mapper.pipeline.briefing.map_briefing_context_curation import build_decision_ready_context_bundle, build_source_coverage_report
from epistemic_case_mapper.pipeline.briefing.map_briefing_decision_packet_stage import attach_decision_briefing_packet, _promote_analyst_packet_as_active
from epistemic_case_mapper.pipeline.briefing.map_briefing_decision_synthesis import build_decision_synthesis_model
from epistemic_case_mapper.pipeline.briefing.map_briefing_evidence_cards import apply_evidence_cards_to_map
from epistemic_case_mapper.pipeline.briefing.map_briefing_final_outputs import (
    ModelBackendConfig,
    write_final_reader_outputs as _write_final_reader_outputs,
)
from epistemic_case_mapper.pipeline.briefing.map_briefing_memo_progress import memo_progress_stage, record_memo_progress, reset_memo_progress
...
from epistemic_case_mapper.pipeline.briefing.map_briefing_model_context import write_model_context_audit
...
from epistemic_case_mapper.pipeline.briefing.map_briefing_run_helpers import prepare_map_briefing_inputs, write_map_briefing_run_summary
from epistemic_case_mapper.pipeline.briefing.map_briefing_seed_brief import deterministic_graph_claim_sentences
from epistemic_case_mapper.pipeline.briefing.map_briefing_spine_bundle import build_decision_spine_bundle
from epistemic_case_mapper.pipeline.briefing.map_briefing_text_cleanup import reader_facing_unresolved_family, reader_facing_unresolved_slot
ROLE_PRIORITY = {
    "crux": 0,
    "scope_limit": 1,
    "external_validity": 1,
...
def briefing_scaffold(
    ...
    from epistemic_case_mapper.pipeline.briefing.map_briefing_decision_support_model import (
