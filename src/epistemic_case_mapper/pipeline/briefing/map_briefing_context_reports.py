...
from epistemic_case_mapper.pipeline.briefing.map_briefing_source_claim_context import claim_context as _claim_context
from epistemic_case_mapper.pipeline.briefing.map_briefing_source_claim_context import whole_doc_source_card as _whole_doc_source_card
...
def build_pipeline_migration_ledger(
    *,
    ...
    return PipelineMigrationLedger(
        ...
        transition_notes=[] if projection_ready else ["main memo obligations remain as validation obligations until fully replaced"],
        status=status,
    ).model_dump()
