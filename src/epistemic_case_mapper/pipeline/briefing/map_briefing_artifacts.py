...
from epistemic_case_mapper.pipeline.briefing.map_briefing_telemetry import write_gap_telemetry
from epistemic_case_mapper.pipeline.briefing.map_briefing_spine_audit import (
    render_before_after_briefing_comparison,
    render_spine_completion_audit,
)
from epistemic_case_mapper.pipeline.briefing.map_briefing_memo_ready_packet import build_memo_ready_packet_synthesis_prompt
from epistemic_case_mapper.pipeline.briefing.map_briefing_memo_ready_prompt import build_writer_packet_synthesis_prompt
...
def _scaffold_artifact_specs() -> tuple[ArtifactSpec, ...]:
    return (
        ...
        ArtifactSpec("decision_problem_report", "decision_problem_report.json", "json", _scaffold_value("decision_problem_report"), review_label="Decision problem report"),
        ArtifactSpec("candidate_answer_set", "candidate_answer_set.json", "json", _scaffold_value("candidate_answer_set"), review_label="Candidate answer set"),
        ArtifactSpec("source_evidence_graph", "source_evidence_graph.json", "json", _scaffold_value("source_evidence_graph"), review_label="Source evidence graph"),
        ArtifactSpec("decision_obligation_graph", "decision_obligation_graph.json", "json", _scaffold_value("decision_obligation_graph"), review_label="Decision obligation graph"),
        ArtifactSpec("evidence_answer_matrix", "evidence_answer_matrix.json", "json", _scaffold_value("evidence_answer_matrix"), review_label="Evidence-answer matrix"),
        ArtifactSpec("evidence_answer_matrix_quality_report", "evidence_answer_matrix_quality_report.json", "json", _scaffold_value("evidence_answer_matrix_quality_report"), review_label="Evidence-answer matrix quality"),
        ArtifactSpec("decision_slots", "decision_slots.json", "json", _scaffold_value("decision_slots"), review_label="Decision slots"),
        ...
        *_packet_critique_artifact_specs(),
        ...
        ArtifactSpec("decision_usefulness_inventory_report", "decision_usefulness_inventory_report.json", "json", _scaffold_value("decision_usefulness_inventory_report"), review_label="Decision usefulness inventory"),
        ArtifactSpec("decision_usefulness_context", "decision_usefulness_context.json", "json", _scaffold_value("decision_usefulness_context"), review_label="Decision usefulness context"),
        ArtifactSpec("decision_usefulness_prompt", "decision_usefulness_prompt.txt", "markdown", _scaffold_text("decision_usefulness_prompt")),
        ArtifactSpec("decision_usefulness_raw", "decision_usefulness_raw.txt", "markdown", _scaffold_text("decision_usefulness_raw")),
        ArtifactSpec("decision_usefulness_parse_report", "decision_usefulness_parse_report.json", "json", _scaffold_value("decision_usefulness_parse_report"), review_label="Decision usefulness parse report"),
        ArtifactSpec("decision_usefulness_packet", "decision_usefulness_packet.json", "json", _scaffold_value("decision_usefulness_packet"), review_label="Decision usefulness packet"),
        ArtifactSpec("decision_usefulness_quality_report", "decision_usefulness_quality_report.json", "json", _scaffold_value("decision_usefulness_quality_report"), review_label="Decision usefulness quality"),
        ArtifactSpec("decision_usefulness_report", "decision_usefulness_report.json", "json", _scaffold_value("decision_usefulness_report"), review_label="Decision usefulness report"),
        ArtifactSpec("decision_usefulness_repair_prompt", "decision_usefulness_repair_prompt.txt", "markdown", _scaffold_text("decision_usefulness_repair_prompt")),
        ArtifactSpec("decision_usefulness_repair_raw", "decision_usefulness_repair_raw.txt", "markdown", _scaffold_text("decision_usefulness_repair_raw")),
        ArtifactSpec("decision_usefulness_repair_report", "decision_usefulness_repair_report.json", "json", _scaffold_value("decision_usefulness_repair_report"), review_label="Decision usefulness repair"),
        ArtifactSpec("lightweight_writer_guidance_prompt", "lightweight_writer_guidance_prompt.txt", "markdown", _scaffold_text("lightweight_writer_guidance_prompt")),
        ArtifactSpec("lightweight_writer_guidance_raw", "lightweight_writer_guidance_raw.txt", "markdown", _scaffold_text("lightweight_writer_guidance_raw")),
        ArtifactSpec("lightweight_writer_guidance", "lightweight_writer_guidance.json", "json", _scaffold_value("lightweight_writer_guidance"), review_label="Lightweight writer guidance"),
        ArtifactSpec("lightweight_writer_guidance_report", "lightweight_writer_guidance_report.json", "json", _scaffold_value("lightweight_writer_guidance_report"), review_label="Lightweight writer guidance report"),
        ArtifactSpec("analyst_evidence_ledger", "analyst_evidence_ledger.json", "json", _scaffold_value("analyst_evidence_ledger"), review_label="Analyst evidence ledger"),
        ArtifactSpec("analyst_adjudication_prompt", "analyst_adjudication_prompt.txt", "markdown", _scaffold_text("analyst_adjudication_prompt")),
        ArtifactSpec("analyst_adjudication_raw", "analyst_adjudication_raw.txt", "markdown", _scaffold_text("analyst_adjudication_raw")),
        ...
        *_global_decision_artifact_specs(),
        ...
        ArtifactSpec("analyst_decision_model_repair_raw", "analyst_decision_model_repair_raw.txt", "markdown", _scaffold_text("analyst_decision_model_repair_raw")),
        ArtifactSpec("analyst_decision_model_repair_parse_report", "analyst_decision_model_repair_parse_report.json", "json", _scaffold_value("analyst_decision_model_repair_parse_report"), review_label="Analyst decision model repair parse report"),
        ArtifactSpec("analyst_decision_model_repair_report", "analyst_decision_model_repair_report.json", "json", _scaffold_value("analyst_decision_model_repair_report"), review_label="Analyst decision model repair report"),
        ArtifactSpec("analyst_packet_refinement_prompt", "analyst_packet_refinement_prompt.txt", "markdown", _scaffold_text("analyst_packet_refinement_prompt")),
        ArtifactSpec("analyst_packet_refinement_raw", "analyst_packet_refinement_raw.txt", "markdown", _scaffold_text("analyst_packet_refinement_raw")),
...
def _global_decision_artifact_specs() -> tuple[ArtifactSpec, ...]:
    return (
        ...
        ArtifactSpec("relation_value_ablation_report", "relation_value_ablation_report.json", "json", _scaffold_value("relation_value_ablation_report"), review_label="Relation value ablation"),
        ArtifactSpec("reviewer_effort_ablation_report", "reviewer_effort_ablation_report.json", "json", _scaffold_value("reviewer_effort_ablation_report"), review_label="Reviewer effort ablation"),
        ArtifactSpec("compact_review_packet", "compact_review_packet.json", "json", _scaffold_value("compact_review_packet"), review_label="Compact review packet"),
