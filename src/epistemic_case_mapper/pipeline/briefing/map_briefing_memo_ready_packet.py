...
from epistemic_case_mapper.pipeline.briefing.map_briefing_quantity_binding import build_quantity_binding_report
...
from epistemic_case_mapper.pipeline.briefing.map_briefing_memo_ready_prompt import build_memo_ready_packet_synthesis_prompt
...
from epistemic_case_mapper.pipeline.briefing.map_briefing_source_claim_context import merged_cluster_source_context as _merged_cluster_source_context
...
def build_quality_synthesis_packet_bundle(packet: dict[str, Any]) -> dict[str, dict[str, Any]]:
    from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_evidence_ledger import build_analyst_evidence_ledger
