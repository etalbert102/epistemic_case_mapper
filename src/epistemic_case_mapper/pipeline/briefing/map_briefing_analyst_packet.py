...
from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_decision_logic import analyst_decision_logic
from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_decision_groups import build_groups_from_decision_model
...
from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_role_projection import (
...
from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_packet_helpers import (
...
from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_schemas import AnalystSynthesisPacket
...
from epistemic_case_mapper.pipeline.briefing.map_briefing_reader_packet_contract import build_memo_ready_decision_synthesis_contract
    ...
    return _drop_empty(
        {
            ...
            "evidence_bundle_id": str(binding.get("evidence_bundle_id") or "").strip(),
            "assertion_bundle": binding.get("assertion_bundle") if isinstance(binding.get("assertion_bundle"), dict) else {},
            ...
            "statistic_type": str(_dict(binding.get("assertion_bundle")).get("statistic_type") or binding.get("claim_quantity_type") or "").strip(),
            "endpoint": str(_dict(binding.get("assertion_bundle")).get("endpoint") or binding.get("measures") or "").strip(),
            "population": str(_dict(binding.get("assertion_bundle")).get("population") or "").strip(),
            "exposure_or_comparator": str(_dict(binding.get("assertion_bundle")).get("exposure_or_comparator") or "").strip(),
            "interval": str(_dict(binding.get("assertion_bundle")).get("interval") or "").strip(),
            "allowed_inference": str(_dict(binding.get("assertion_bundle")).get("allowed_inference") or "").strip(),
            "forbidden_inference": str(_dict(binding.get("assertion_bundle")).get("forbidden_inference") or "").strip(),
