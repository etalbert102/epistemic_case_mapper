...
def build_reader_packet_verbalization_prompt(reader_packet: dict[str, Any]) -> str:
    ...
    return (
        ...
        "- Use numbers, sources, examples, populations, causal claims, and recommendations already present on the card.\n"
        "- Write reader-facing prose focused on the claim, source label, and decision relevance.\n"
