...
from epistemic_case_mapper.pipeline.briefing.map_briefing_memo_warning_packet import build_memo_warning_packet
...
def attach_decision_briefing_packet(
    ...
    *,
    ...
    from epistemic_case_mapper.pipeline.briefing.map_briefing_readiness import build_packet_quality_gate_report
...
def _run_analyst_decision_model(
    ...
    *,
    ...
    from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_evidence_routing import build_analyst_evidence_routing_bundle
    from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_decision_modeling import run_analyst_decision_model
    ...
    from epistemic_case_mapper.pipeline.briefing.map_briefing_decision_writer_packet import build_decision_writer_packet_bundle
...
def _run_analyst_packet_builders(scaffold: dict[str, Any], packet: dict[str, Any], ledger: dict[str, Any], *, backend_config: Any, progress: Callable[[str, str, dict[str, Any] | None], None] | None) -> None:
    ...
    from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_quantity_binding import run_analyst_quantity_binding
    ...
    from epistemic_case_mapper.pipeline.briefing.map_briefing_model_source_weighting import (
        attach_model_source_weighting_to_packet,
        run_model_source_weight_judgments,
    )
    from epistemic_case_mapper.pipeline.briefing.map_briefing_source_id_projection import project_memo_ready_packet_source_ids
    ...
    if _decision_writer_packet_ready(scaffold.get("decision_writer_packet"), scaffold.get("decision_writer_packet_quality_report")):
        ...
        from epistemic_case_mapper.pipeline.briefing.map_briefing_analyst_refinement import run_analyst_packet_refinement
...
def _promote_decision_writer_packet_as_active(scaffold: dict[str, Any]) -> bool:
    from epistemic_case_mapper.pipeline.briefing.map_briefing_decision_writer_packet import decision_writer_packet_to_memo_ready_packet
