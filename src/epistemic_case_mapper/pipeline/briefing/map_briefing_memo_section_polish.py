...
from epistemic_case_mapper.pipeline.briefing.map_briefing_memo_ready_packet_helpers import dict_value as _dict
...
def build_section_memo_polish_prompt(
    ...
    *,
    ...
    return (
        ...
        "- Improve paragraph flow inside this section while preserving other sections.\n"
        ...
        "- Keep mechanisms, trends, thresholds, and recommendations within the section and guardrails.\n\n"
        ...
        "- Practical sections: translate the answer into the action-relevant implication using existing scope and caveats.\n\n"
        "JSON schema:\n"
        "{\n"
        ...
        "- Use facts, numbers, sources, populations, recommendations, and comparisons already present in this section or guardrails.\n"
...
def _build_completion_only_section_prompt(
    ...
    *,
    ...
    return (
        ...
        "- If the section is complete, return it unchanged.\n\n"
        "Style target:\n"
        ...
        "- Keep the repair scoped to completion of the unfinished text.\n\n"
        "JSON schema:\n"
        "{\n"
        '  "section_markdown": "replacement markdown for this section only",\n'
        ...
        "- Use only facts, numbers, populations, source IDs, and comparisons already present in this section or guardrails.\n\n"
        f"Section type: {section_type}\n"
        f"Section heading: {section.get('heading')}\n"
        f"Decision question: {packet.get('decision_question')}\n\n"
        f"Source registry:\n{json.dumps(source_id_registry_for_model(source_trail), indent=2, ensure_ascii=False)}\n\n"
