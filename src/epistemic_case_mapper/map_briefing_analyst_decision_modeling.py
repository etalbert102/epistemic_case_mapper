...
def build_analyst_decision_model_prompt(context: dict[str, Any]) -> str:
    packet = {
        ...
        "task": [
            ...
            "Do not use load_bearing_counterweight for evidence that only rebuts a rejected or feared alternative while supporting a selected/provisional current_best_answer. In that case use load_bearing_primary_support, mechanism_or_context, or decision_crux and make effect_on_final_answer explicit.",
