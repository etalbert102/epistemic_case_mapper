...
def _add_semantic_parsers(subparsers: Any) -> None:
    ...
    semantic_staged_map.add_argument("--max-claims-per-chunk", type=int, default=8, help="For whole-doc extraction this is the max canonical claims per source.")
    semantic_staged_map.add_argument("--claim-extractor", choices=["whole-doc", "native", "langextract"], default="whole-doc")
    ...
    semantic_staged_map.add_argument("--no-claim-cache", action="store_true", help="Ignore existing per-chunk canonical claim outputs and call the backend for every chunk.")
    ...
    semantic_staged_brief.add_argument("--max-claims-per-chunk", type=int, default=8, help="For whole-doc extraction this is the max canonical claims per source.")
    semantic_staged_brief.add_argument("--claim-extractor", choices=["whole-doc", "native", "langextract"], default="whole-doc")
    ...
    semantic_staged_brief.add_argument("--no-claim-cache", action="store_true", help="Ignore existing per-chunk canonical claim outputs and call the backend for every chunk.")
