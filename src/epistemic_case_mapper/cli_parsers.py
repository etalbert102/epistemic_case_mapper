...
def _add_baseline_synthesize_review_parsers(subparsers: Any) -> None:
    ...
    map_briefing.add_argument("--run-reader-memo-rewrite", action="store_true", help="Run the optional whole-memo edit-suggestion pass after section synthesis.")
...
def _add_semantic_parsers(subparsers: Any) -> None:
    ...
    semantic_staged_map.add_argument("--claim-extractor", choices=["native", "langextract"], default="native")
    ...
    semantic_staged_brief.add_argument("--claim-extractor", choices=["native", "langextract"], default="native")
